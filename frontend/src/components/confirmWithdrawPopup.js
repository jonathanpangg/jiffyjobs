...
export function WithdrawPopup({ open, onClose, onSubmit, profile }) {
    ...
    return (
        <Dialog open={open} onClose={onClose} PaperProps={{ sx: { borderRadius: "15px", margin: 'auto', width: '480px', height: '622px', transform: 'scale(0.85)' } }}>
            <DialogTitle sx={{ textAlign: 'center', fontFamily: 'Outfit', marginTop: 2, fontSize: '24px', fontWeight: 500 }}>Are you sure you want to withdraw?</DialogTitle>
