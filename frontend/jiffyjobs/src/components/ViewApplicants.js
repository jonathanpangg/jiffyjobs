                ...
                <div>
                    ...
                    <Dialog open={open} onClose={() => {setOpen(false)}}>
                        <DialogTitle style={{width: '520px', display: 'flex', justifyContent: 'center', fontFamily: 'Outfit', fontSize: '24px', fontWeight: '500', bold: 'none'}}>
                            ...
                            <div style={{marginTop: '2.5%'}}> { typeResponse === 'standard' ? "Applicant Profile": (typeResponse === "accept" ? 'Are you sure you want to accept?': 'Are you sure you want to reject?')} </div>
                        </DialogTitle>
                        <DialogContent style={{display: 'flex', justifyContent: 'center'}}>
                            <div style={{ width: '431px', height: '399px', border: '1px solid #A4A4A4', borderRadius: '10px', backgroundColor: typeResponse === 'standard' ? "white": (typeResponse === "accept" ? 'rgba(102, 193, 32, 0.15)': 'rgba(193, 32, 32, 0.15)')}}>
                                <DialogContentText>
