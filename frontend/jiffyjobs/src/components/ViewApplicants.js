        ...
        <div>
            ...
            <Dialog open={open} onClose={() => {setOpen(false)}}>
                <DialogTitle style={{width: '520px', display: 'flex', justifyContent: 'center', fontFamily: 'Outfit', fontSize: '24px', fontWeight: '500', bold: 'none'}}>
                    ...
                    <div style={{marginTop: '2.5%'}}> Applicant Profile </div>
                </DialogTitle>
                <DialogContent style={{display: 'flex', justifyContent: 'center'}}>
                    <div style={{ width: '431px', height: '399px', border: '1px solid #A4A4A4', borderRadius: '10px'}}>
                        <DialogContentText>
                ...
                <DialogActions>
                    <div style={{display: 'flex', marginRight: '60px'}}>
                        <Button sx={{textTransform: 'none'}} style={{width: '93px', height: '42px', color: 'white', backgroundColor: '#66C120', marginRight: '10px', borderRadius: '10px'}} onClick={() => {acceptUser(applicant[4], jobID); setOpen(false); setApplicantData([])}}> Accept </Button>
                        <Button sx={{textTransform: 'none'}} style={{width: '93px', height: '42px', color: 'white', backgroundColor: '#C12020', borderRadius: '10px'}} onClick={() => {rejectUser(applicant[4], jobID); setOpen(false); setApplicantData([])}} autoFocus> Reject </Button>
                    </div>
                </DialogActions>
            </Dialog>
        </div>
